...
from llm_core.copilot import CopilotCore
...
from llm_core.llm_utils import read_raw_data, save_raw_to_local, save_result_to_local
from fastapi import (
    FastAPI,
    HTTPException,
    Request,
...
class FastApiInterface:
    ...
    def ssetup_routers(self) -> None:
        ...
        async def generate_code_api(request: GenerateCodeRequest) -> Any:
            respone = ""
            try:
